...
const MISTWOOD: number[][] = [
  ...
  [1, 4, 0, 2, 2, 2, 0, 0, 3, 3, 0, 0, 0, 4, 1],
  [1, 0, 1, 2, 0, 2, 0, 1, 3, 0, 1, 1, 0, 0, 1],
  [1, 0, 0, 2, 0, 2, 2, 2, 2, 2, 2, 0, 0, 0, 1],
  [1, 3, 3, 2, 0, 0, 0, 1, 0, 0, 2, 2, 1, 0, 1],
  [1, 3, 0, 2, 2, 2, 0, 0, 0, 0, 2, 0, 0, 5, 1],
  [1, 0, 1, 0, 0, 2, 1, 1, 0, 2, 2, 0, 3, 3, 1],
  [1, 0, 0, 0, 0, 2, 2, 2, 2, 2, 0, 0, 3, 0, 1],
  [1, 0, 1, 0, 1, 0, 0, 3, 0, 2, 2, 2, 0, 0, 1],
...
export const ZONES: Record<ZoneId, ZoneDef> = {
  mistwood: {
    ...
    name: 'Mistwood',
    nameZh: '霧林外緣',
    hint: '新手區：哥布林、灰狼會出沒。紫霧遇敵，藍門通往廢墟。',
    map: MISTWOOD,
    spawn: { x: 3, y: 5 },
    portalTo: 'ruins',
    portalSpawn: { x: 2, y: 9 },
